...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Post', fields ['user']
        db.delete_unique(u'network_post', ['user_id'])


        # Changing field 'Post.user'
        db.alter_column(u'network_post', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Post.user'
        db.alter_column(u'network_post', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Post', fields ['user']
        db.create_unique(u'network_post', ['user_id'])
