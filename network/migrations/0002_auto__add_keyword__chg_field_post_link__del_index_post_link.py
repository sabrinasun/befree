...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'network_post', 'link', self.gf('django.db.models.fields.URLField')(max_length=200))
        # Removing index on 'Post', fields ['link']
        db.delete_index(u'network_post', ['link'])


    def backwards(self, orm):
        # Adding index on 'Post', fields ['link']
        db.create_index(u'network_post', ['link'])
        ...
        # Changing field 'Post.link'
        db.alter_column(u'network_post', 'link', self.gf('django.db.models.fields.SlugField')(max_length=50))
