...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'network_post', 'link')

        # Deleting field 'Post.link_http_mode'
        db.delete_column(u'network_post', 'link_http_mode')


    def backwards(self, orm):
        # Adding field 'Post.link'
        db.add_column(u'network_post', 'link',
                      self.gf('django.db.models.fields.URLField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.link_http_mode'
        db.add_column(u'network_post', 'link_http_mode',
