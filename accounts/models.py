...
class Profile(UserenaBaseProfile):
    ...
    def validate_giver(self, local_pickup, domestic_pay_shipping, domestic_free_shipping, international_free_shipping,
                       pickup_description, paypal_email, payment_description):
        ...
        if domestic_pay_shipping and domestic_free_shipping:
            raise ValidationError(
                "Please choose either  Free Domestic Shipping or Receive Payment for Domestic Shipping, not both.")
        ...
        if domestic_pay_shipping and not (paypal_email or payment_description):
            raise ValidationError(
                "Sorry receivers need to pay your for shipping. Either Paypal Email or Other Payment Methods is required for giver profile. ")
    ...
    def has_giver_profile(self):
        try:
            self.validate_giver(self.local_pickup, self.domestic_pay_shipping, self.domestic_free_shipping, \
                                self.international_free_shipping, self.pickup_description, self.paypal_email,
