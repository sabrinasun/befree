...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'accounts_profile', 'country', self.gf('django_countries.fields.CountryField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Profile.country'
        db.alter_column(u'accounts_profile', 'country', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        u'accounts.profile': {
            ...
            'country': ('django_countries.fields.CountryField', [], {'max_length': '50', 'blank': 'True'}),
