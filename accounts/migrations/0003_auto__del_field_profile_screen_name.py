...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.screen_name'
        db.delete_column(u'accounts_profile', 'screen_name')


    def backwards(self, orm):
        # Adding field 'Profile.screen_name'
        db.add_column(u'accounts_profile', 'screen_name',
