...
urlpatterns = patterns(
    ...
    url(r'^account/giver-material/edit/(?P<pk>\d+)/$', login_required(GiverMaterialEditView.as_view()),
        name='giver_material_edit'),
    url(r'^account/material/(?P<material_id>\d+)/edit/$', 'account_material_edit',
        name='account_material_edit'),
    ...
    url(r'^check-out/$', 'check_out', name='check_out'),
    url(r'^view-bag/$', 'view_bag', name='view_bag'),
    url(r'^view-bag/delete/(?P<inventory_id>\d+)/$', 'view_bag_delete', name='view_bag_delete'),
    url(r'^contact-user/$', 'contact_user', name='contact_user'),
    url(r'^pay-giver/$', 'pay_giver', name='pay_giver'),
    url(r'^file-claim/$', 'file_claim', name='file_claim'),
)
