...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_givermaterial', 'material',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Material'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'core.givermaterial': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'material': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Material']", 'null': 'True', 'blank': 'True'}),
