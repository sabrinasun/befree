...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Material.has_pic'
        db.delete_column(u'core_material', 'has_pic')

        # Adding field 'Material.pic'
        db.add_column(u'core_material', 'pic',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Material.pdf'
        db.alter_column(u'core_material', 'pdf', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):
        # Adding field 'Material.has_pic'
        db.add_column(u'core_material', 'has_pic',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Material.pic'
        db.delete_column(u'core_material', 'pic')


        # Changing field 'Material.pdf'
        db.alter_column(u'core_material', 'pdf', self.gf('django.db.models.fields.CharField')(default=None, max_length=10))
    ...
    models = {
        ...
        u'core.material': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'Book'", 'max_length': '10'}),
