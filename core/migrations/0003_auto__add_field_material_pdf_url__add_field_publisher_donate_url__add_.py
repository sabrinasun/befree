...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Material.pdf_url'
        db.add_column(u'core_material', 'pdf_url',
                      self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publisher.donate_url'
        db.add_column(u'core_publisher', 'donate_url',
                      self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publisher.donate_note'
        db.add_column(u'core_publisher', 'donate_note',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Author.donate_url'
        db.add_column(u'core_author', 'donate_url',
                      self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Author.donate_note'
        db.add_column(u'core_author', 'donate_note',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Material.pdf_url'
        db.delete_column(u'core_material', 'pdf_url')

        # Deleting field 'Publisher.donate_url'
        db.delete_column(u'core_publisher', 'donate_url')

        # Deleting field 'Publisher.donate_note'
        db.delete_column(u'core_publisher', 'donate_note')

        # Deleting field 'Author.donate_url'
        db.delete_column(u'core_author', 'donate_url')

        # Deleting field 'Author.donate_note'
        db.delete_column(u'core_author', 'donate_note')
