...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Material.status'
        db.delete_column(u'core_material', 'status')

        # Deleting field 'Material.giver'
        db.delete_column(u'core_material', 'giver_id')

        # Deleting field 'Material.type'
        db.delete_column(u'core_material', 'type')

        # Deleting field 'Material.condition'
        db.delete_column(u'core_material', 'condition')

        # Deleting field 'Material.quantity'
        db.delete_column(u'core_material', 'quantity')

        # Adding field 'Material.typ'
        db.add_column(u'core_material', 'typ',
                      self.gf('django.db.models.fields.CharField')(default='Book', max_length=10),
                      keep_default=False)

        # Deleting field 'GiverMaterial.count'
        db.delete_column(u'core_givermaterial', 'count')

        # Deleting field 'GiverMaterial.material'
        db.delete_column(u'core_givermaterial', 'material_id')

        # Adding field 'GiverMaterial.quantity'
        db.add_column(u'core_givermaterial', 'quantity',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Material.status'
        db.add_column(u'core_material', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Active', max_length=10),
                      keep_default=False)
        ...
        db.add_column(u'core_material', 'type',
                      self.gf('django.db.models.fields.CharField')(default='Book', max_length=10),
                      keep_default=False)

        # Adding field 'Material.condition'
        db.add_column(u'core_material', 'condition',
                      self.gf('django.db.models.fields.CharField')(default='Good', max_length=10),
                      keep_default=False)

        # Adding field 'Material.quantity'
        db.add_column(u'core_material', 'quantity',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'Material.typ'
        db.delete_column(u'core_material', 'typ')

        # Adding field 'GiverMaterial.count'
        db.add_column(u'core_givermaterial', 'count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GiverMaterial.material'
        db.add_column(u'core_givermaterial', 'material',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Material']),
                      keep_default=False)

        # Deleting field 'GiverMaterial.quantity'
        db.delete_column(u'core_givermaterial', 'quantity')
