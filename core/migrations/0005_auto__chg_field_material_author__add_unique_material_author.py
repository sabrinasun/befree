...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Material.author'
        db.alter_column(u'core_material', 'author_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Author'], unique=True))
        # Adding unique constraint on 'Material', fields ['author']
        db.create_unique(u'core_material', ['author_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Material', fields ['author']
        db.delete_unique(u'core_material', ['author_id'])


        # Changing field 'Material.author'
        db.alter_column(u'core_material', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Author']))
    ...
    models = {
        ...
        u'core.material': {
            ...
            'author': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.Author']", 'unique': 'True'}),
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
