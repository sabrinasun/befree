...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'GiverMaterial', fields ['material', 'giver']
        db.create_unique(u'core_givermaterial', ['material_id', 'giver_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'GiverMaterial', fields ['material', 'giver']
        db.delete_unique(u'core_givermaterial', ['material_id', 'giver_id'])
