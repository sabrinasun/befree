...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Material.author'
        db.delete_column(u'core_material', 'author_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Material.author'
        raise RuntimeError("Cannot reverse this migration. 'Material.author' and its values cannot be restored.")
